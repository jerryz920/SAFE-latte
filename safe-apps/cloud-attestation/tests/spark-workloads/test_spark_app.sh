...
postPodPolicy bob configset1 safe-spark-app
...
postQualifierPolicy bob configset1 '[\"spark:v2.3\",[\"arg0\",\"driver\"]]'
...
postPodPolicy alice configset2 safe-spark-app
...
postGroupAdmissionPolicy alice alice:tag0 "safe-spark-app" bob
postGroupAdmissionPolicy alice alice:tag0 "safe-spark-app" alice
